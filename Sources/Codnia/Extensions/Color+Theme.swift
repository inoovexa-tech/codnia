...
extension Color {
    ...
    static let syntaxKeyword  = Color(hex: "#ff7b72")
    static let syntaxString   = Color(hex: "#a5d6ff")
    static let syntaxComment  = Color(hex: "#8b949e")
    static let syntaxNumber   = Color(hex: "#79c0ff")
    static let syntaxType     = Color(hex: "#ffa657")
    static let syntaxFunction = Color(hex: "#d2a8ff")
    static let syntaxProperty = Color(hex: "#79c0ff")
    static let syntaxConstant = Color(hex: "#79c0ff")
    static let syntaxOperator = Color(hex: "#ff7b72")
...
extension NSColor {
    ...
    static let accentOrange  = NSColor(Color.accentOrange)
    static let borderLight   = NSColor(Color.borderLight)
    static let textTertiary  = NSColor(Color.textTertiary)
    static let selectionBg   = NSColor(Color.selectionBg)
    static let syntaxKeyword  = NSColor(Color.syntaxKeyword)
    static let syntaxString   = NSColor(Color.syntaxString)
    static let syntaxComment  = NSColor(Color.syntaxComment)
    static let syntaxNumber   = NSColor(Color.syntaxNumber)
    static let syntaxType     = NSColor(Color.syntaxType)
    static let syntaxFunction = NSColor(Color.syntaxFunction)
    static let syntaxProperty = NSColor(Color.syntaxProperty)
    static let syntaxConstant = NSColor(Color.syntaxConstant)
    static let syntaxOperator = NSColor(Color.syntaxOperator)
}
