...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ref={ref}
    className="peer inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors data-[state=checked]:bg-[#0070f3] data-[state=unchecked]:bg-[#1a1a1a]"
    {...props}
  >
