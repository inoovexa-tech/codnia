...
export function ActivityBar({
  ...
  return (
    <div className="w-[280px] min-w-[280px] bg-[#000000] border-l border-[#1a1a1a] flex flex-col relative shrink-0">
      <div className="absolute left-0 top-0 bottom-0 w-1.5 cursor-ew-resize z-20 hover:bg-[#0070f3] transition-colors" />

      <div className="h-12 flex items-center justify-between border-b border-[#1a1a1a]" style={{ padding: "0 10px" }}>
